...
impl<'ctx> RuntimeFunctions<'ctx> {
    pub(super) fn declare(
        ...
        execution_engine
            .add_global_mapping(&count_executed_block, rt_count_executed_block as *const() as usize);
        ...
        execution_engine.add_global_mapping(&move_steps, rt_motion_move_steps as *const() as usize);
        ...
        execution_engine.add_global_mapping(&set_direction, rt_motion_set_direction as *const() as usize);
        ...
        execution_engine.add_global_mapping(&change_x, rt_motion_change_x as *const() as usize);
        ...
        execution_engine.add_global_mapping(&change_y, rt_motion_change_y as *const() as usize);
        ...
        execution_engine.add_global_mapping(&set_x, rt_motion_set_x as *const() as usize);
        ...
        execution_engine.add_global_mapping(&set_y, rt_motion_set_y as *const() as usize);
        ...
        execution_engine.add_global_mapping(&goto_xy, rt_motion_goto_xy as *const() as usize);
        ...
        execution_engine.add_global_mapping(&motion_x_position, rt_motion_x_position as *const() as usize);
        ...
        execution_engine.add_global_mapping(&motion_y_position, rt_motion_y_position as *const() as usize);
        ...
        execution_engine.add_global_mapping(&get_var, rt_get_var as *const() as usize);
        ...
        execution_engine.add_global_mapping(&set_var, rt_set_var as *const() as usize);
        ...
        execution_engine.add_global_mapping(&change_var, rt_change_var as *const() as usize);
        ...
        execution_engine.add_global_mapping(&data_add_to_list, rt_data_add_to_list as *const() as usize);
        ...
        execution_engine.add_global_mapping(&data_delete_of_list, rt_data_delete_of_list as *const() as usize);
        ...
        execution_engine.add_global_mapping(&looks_set_effect_to, rt_looks_set_effect_to as *const() as usize);
        ...
        execution_engine.add_global_mapping(&looks_set_size, rt_looks_set_size as *const() as usize);
        ...
        execution_engine
            .add_global_mapping(&looks_costume_number, rt_looks_costume_number as *const() as usize);
        ...
        execution_engine.add_global_mapping(&looks_costume_name, rt_looks_costume_name as *const() as usize);
        ...
        execution_engine.add_global_mapping(&music_set_tempo, rt_music_set_tempo as *const() as usize);
        ...
        execution_engine
            .add_global_mapping(&sensing_ask_and_wait, rt_sensing_ask_and_wait as *const() as usize);
        ...
        execution_engine.add_global_mapping(&sensing_answer, rt_sensing_answer as *const() as usize);
        ...
        execution_engine.add_global_mapping(&sensing_current, rt_sensing_current as *const() as usize);
        ...
        execution_engine
            .add_global_mapping(&sensing_touching_color, rt_sensing_touching_color as *const() as usize);
        ...
        execution_engine.add_global_mapping(&sensing_reset_timer, rt_sensing_reset_timer as *const() as usize);
        ...
        execution_engine.add_global_mapping(&pen_set_color_param, rt_pen_set_color_param as *const() as usize);
        ...
        execution_engine
            .add_global_mapping(&control_create_clone, rt_control_create_clone_of as *const() as usize);
        ...
        execution_engine
            .add_global_mapping(&control_delete_clone, rt_control_delete_this_clone as *const() as usize);
        ...
        execution_engine.add_global_mapping(&operator_length, rt_operator_length as *const() as usize);
        ...
        execution_engine.add_global_mapping(&operator_contains, rt_operator_contains as *const() as usize);
        ...
        execution_engine.add_global_mapping(&operator_round, rt_operator_round as *const() as usize);
        ...
        execution_engine.add_global_mapping(&operator_letter_of, rt_operator_letter_of as *const() as usize);
        ...
        execution_engine.add_global_mapping(&operator_mathop, rt_operator_mathop as *const() as usize);
        ...
        execution_engine.add_global_mapping(&operator_subtract, rt_operator_subtract as *const() as usize);
        ...
        execution_engine.add_global_mapping(&operator_multiply, rt_operator_multiply as *const() as usize);
        ...
        execution_engine.add_global_mapping(&operator_divide, rt_operator_divide as *const() as usize);
        ...
        execution_engine.add_global_mapping(&operator_equals, rt_operator_equals as *const() as usize);
        ...
        execution_engine
            .add_global_mapping(&operator_greater_than, rt_operator_greater_than as *const() as usize);
        ...
        execution_engine.add_global_mapping(&operator_less_than, rt_operator_less_than as *const() as usize);
        ...
        execution_engine.add_global_mapping(&data_item_of_list, rt_data_item_of_list as *const() as usize);
        ...
        execution_engine
            .add_global_mapping(&data_item_num_of_list, rt_data_item_num_of_list as *const() as usize);
        ...
        execution_engine.add_global_mapping(&data_length_of_list, rt_data_length_of_list as *const() as usize);
        ...
        execution_engine.add_global_mapping(&sensing_mouse_x, rt_sensing_mouse_x as *const() as usize);
        ...
        execution_engine.add_global_mapping(&sensing_mouse_y, rt_sensing_mouse_y as *const() as usize);
        ...
        execution_engine.add_global_mapping(&sensing_mouse_down, rt_sensing_mouse_down as *const() as usize);
        ...
        execution_engine.add_global_mapping(&sensing_key_pressed, rt_sensing_key_pressed as *const() as usize);
        ...
        execution_engine
            .add_global_mapping(&event_broadcast_value, rt_event_broadcast_value as *const() as usize);
        ...
        execution_engine
            .add_global_mapping(&loop_should_continue, rt_loop_should_continue as *const() as usize);
